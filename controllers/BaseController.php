...
abstract class BaseController
{
    ...
    function __construct(string $controllerName, string $actionName)
    {
        ...
        $this->setProfile = isset($_SESSION['profileID']);
		$this->isReg = isset($_SESSION['status']);
    ...
    public function authorize() {
        if (! $this->isLoggedIn) {
            $this->addErrorMessage("Моля първо влезте в системата или изчакайте одобрение от Администратора");
